...
public class VideocardAdapter extends RecyclerView.Adapter<VideocardAdapter.ViewHolder> implements Filterable {
    ...
    public VideocardAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.catalog,
                parent, false);
        return new VideocardAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull VideocardAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
